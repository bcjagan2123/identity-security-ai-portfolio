...
### SailPoint IIQ
- **[History & Change Audit Plugin](./sailpoint-iiq/history-change-audit-plugin)** — Captures AuditEvents across 16 object types with structured before/after diffs; formal TDD with REST API spec and sensitive field masking
- **[Custom Joiner Workflow](./sailpoint-iiq/custom-joiner-workflow)** — Multi-stage approval and conditional provisioning workflow built after determining Rapid Setup Joiner was unsuitable
- **[Claude AI + IIQ Plugin](./sailpoint-iiq/claude-ai-iiq-plugin)** — Full IIQ plugin integrating Anthropic's Claude, with REST backend, BeanShell workflow, and chat UI
- **[Teams + IIQ Integration](./sailpoint-iiq/teams-iiq-integration)** — SSO, Azure Bot, and IIQ Service Code architecture for management-facing presentations
